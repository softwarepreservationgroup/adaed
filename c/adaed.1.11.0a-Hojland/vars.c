...
symbol_expfl;  /* **fl */
  ...
  int iot_ifile INIT(0); /* current trace level for ifile */
  int iot_ofile INIT(0); /* current trace level for ofile */
  int iot_ais_r INIT(0); /* trace level for ais files read */
  int iot_ais_w INIT(0); /* trace level for ais files written */
  int iot_tre_r INIT(0); /* trace level for tre files read */
  int iot_tre_w INIT(0); /* trace level for tre files written */
  int iot_lib_r INIT(0); /* trace level for lib files read */
  int iot_lib_w INIT(0);/* set to trace writing lib file */
  char iot_ofile_type;
  char iot_ifile_type;
